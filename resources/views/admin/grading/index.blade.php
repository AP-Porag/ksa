                            ...
                            <div class="result-if-success w-100">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="#" id="create-receiving-btn" class="btn btn-primary-theme btn-sm text-white" style="margin-right: 15px;">Grade this order</a>
                                        <button class="btn btn-secondary btn-sm reset">Reset</button>
                                    </div>
                                </div>
                                <div class="mt-4">
    ...
    <script>
        ...
        $("#searchBtn").click(function () {
            ...
            if(!inputString){
                ...
                $.ajax({
                    url: '{{ route("admin.grading.getOrderInfo",) }}',
                    type: 'POST',
                    data: {
                        id: inputString,
                    ...
                    success: function(response) {
                        if (response.status == 200){
                            ...
                            let route = '/admin/grading/'+response.data.id+'/edit/'
                            ...
                            resultBoxIfNothingOrError.removeClass('hide').addClass('show')
                            errorText.text('Grading completed')
                        }else if(response.status == 202){
                            resultBoxIfNothingOrError.removeClass('hide').addClass('show')
                            errorText.text('Not ready for grading')
                        }else {
                            resultBoxIfNothingOrError.removeClass('hide').addClass('show')
